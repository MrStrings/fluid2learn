...
public class Nave extends Entidade {
	...
	public void loadSprites(String filename) throws IOException {
		sprites[0] = ImageManager.getInstance().loadImage(filename, 58, 0, 44, 99);
		sprites[1] = ImageManager.getInstance().loadImage(filename, 0, 0, 58, 99);
		sprites[2] = ImageManager.getInstance().flipImage(sprites[0], true, false);
	}
